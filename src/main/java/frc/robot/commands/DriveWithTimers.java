...
public class DriveWithTimers extends CommandBase {
  ...
  public DriveWithTimers(Drivetrain DrivetrainSubsystem, Boolean IsTurning, double PercentSpeed, double Seconds) {
